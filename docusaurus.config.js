...
const config = {
  ...
  projectName: 'paratext-vidsum', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/JenniBeadle/paratext-vidsum/tree/main',
        },
        blog: false,
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/JenniBeadle/paratext-vidsum/',
            label: 'GitHub',
            position: 'right',
          },
          {
